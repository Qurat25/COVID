...
def seed_data():
    ...
    names = ['E-11/4', 'Street 1, E-11/4', 'Street 11, E-11/4', 'F-6', 'Street 39, F-6/1', 'Street 18, F-6/2', 
    ...
    # db.insert_one({"name": 'Street 4, Phase 3 Bahria Town', "latitude": 33.557029618065954, "longitude": 73.11659923087143})
    # db.insert_one({"name": 'Street 21, Phase 3 Bahria Town', "latitude": 33.554147146254735, "longitude": 73.11713805600947})
    # db.insert_one({"name": 'Street 46, Phase 3 Bahria Town', "latitude": 33.52716215784523, "longitude": 73.0609464552199})
    # db.insert_one({"name": 'Street 55, Phase 3 Bahria Town', "latitude": 33.55082108367934, "longitude": 73.11074851127908})
    # db.insert_one({"name": 'Street 57, Phase 3 Bahria Town', "latitude": 33.55191592246163, "longitude": 73.11094432292383})
    # db.insert_one({"name": 'Street 10, Phase 4 Bahria Town', "latitude": 33.55036691366817, "longitude": 73.12966404195008})
